...
#class for populations of AI characters
class Population:
    
    #constructor for the population class, self
    ...
    def update_live_players(self):
        #print("Player alive:", self.player.alive)
    ...
    def next_gen(self):
        ...
        #clone of the champion is added to each species
        for s in self.species:
            children.append(s.champion.clone())
        
        #fille open player slots with children
