...
class Player:
    ...
    #constructor for the player class, self
    def __init__(self):
        ...
        #pygame rectangle (x and y coordinates, length, width)
        self.rect = pygame.Rect(self.x, self.y, 20, 20)
        
        #color of the player character
        self.color = random.randint(100, 255), random.randint(100, 255), random.randint(100, 255)
        
        #velocity
        self.vel = 0
        
        #Is true when player does a jump
        self.flap = False
        
        #if player dies, the condition becomes false
        self.alive = True
        ...
        #decides if bird should flap/jump or not
        self.decision = None
    ...
    #function for drawing character
    def draw(self, window):
        pygame.draw.rect(window, self.color, self.rect)
    
    #function returns true if the player collides with ground
